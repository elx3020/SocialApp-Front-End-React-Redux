...
const CreateComment = (props) =>{
    ...
    <div>
        ...
        <label htmlFor="comment"></label><input type="text" name="comment" id="comment" placeholder="Write a comment..." onChange={handleCommentChange} value={comment}/>
